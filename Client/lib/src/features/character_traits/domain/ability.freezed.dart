...
class _$_Ability implements _Ability {
  ...
  @override
  String toString() {
    return 'Ability(id: $id, groupId: $groupId, creatorId: $creatorId, name: $name, description: $description, isPassive: $isPassive, state: $state, rejectionReason: $rejectionReason, createdAt: $createdAt, modifiedAt: $modifiedAt, approvedAt: $approvedAt, rejectedAt: $rejectedAt)';
  }
