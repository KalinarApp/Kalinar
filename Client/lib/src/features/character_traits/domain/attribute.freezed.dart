...
class _$_Attribute implements _Attribute {
  ...
  @override
  String toString() {
    return 'Attribute(id: $id, groupId: $groupId, creatorId: $creatorId, name: $name, iconData: $iconData, description: $description, category: $category, stepSize: $stepSize, minValue: $minValue, maxValue: $maxValue, state: $state, rejectionReason: $rejectionReason, createdAt: $createdAt, modifiedAt: $modifiedAt, approvedAt: $approvedAt, rejectedAt: $rejectedAt)';
  }
