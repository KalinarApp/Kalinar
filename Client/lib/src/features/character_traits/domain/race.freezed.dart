...
class _$_Race implements _Race {
  ...
  @override
  String toString() {
    return 'Race(id: $id, groupId: $groupId, creatorId: $creatorId, name: $name, description: $description, state: $state, rejectionReason: $rejectionReason, createdAt: $createdAt, modifiedAt: $modifiedAt, approvedAt: $approvedAt, rejectedAt: $rejectedAt)';
  }
