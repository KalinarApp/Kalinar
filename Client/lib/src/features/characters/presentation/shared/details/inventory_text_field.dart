...
class InventoryTextField extends HookConsumerWidget {
  final Character character;

  const InventoryTextField(this.character, {super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return AutoSavingTextField(
      ...
      onSaving: (currentText) async {
        final state = await ref.read(characterControllerProvider).update(character.id, {"inventory": currentText});
