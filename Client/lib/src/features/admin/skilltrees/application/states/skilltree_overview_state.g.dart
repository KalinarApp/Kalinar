...
_$_SkilltreeOverviewState _$$_SkilltreeOverviewStateFromJson(
    ...
    _$_SkilltreeOverviewState(
      ...
      characters: (json['characters'] as Map<String, dynamic>?)?.map(
            (k, e) => MapEntry(
                ...
                (e as List<dynamic>)
                    .map((e) =>
                        SkilltreeOverview.fromJson(e as Map<String, dynamic>))
                    .toList()),
          ) ??
          const {},
...
Map<String, dynamic> _$$_SkilltreeOverviewStateToJson(
        _$_SkilltreeOverviewState instance) =>
    <String, dynamic>{
