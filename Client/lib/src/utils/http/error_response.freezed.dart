...
abstract class $ErrorResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String type, List<String> errors});
}
...
class _$_ErrorResponse implements _ErrorResponse {
  _$_ErrorResponse(this.type, final List<String> errors) : _errors = errors;
  ...
  @override
  String toString() {
    return 'ErrorResponse(type: $type, errors: $errors)';
  }
...
abstract class _ErrorResponse implements ErrorResponse {
  factory _ErrorResponse(final String type, final List<String> errors) =
      _$_ErrorResponse;
