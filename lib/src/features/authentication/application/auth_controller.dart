...
class AuthController extends StateNotifier<AsyncValue<void>> {
  ...
  AuthController({required this.authRepository, required this.groups}) : super(const AsyncData(null));
...
final authControllerProvider = StateNotifierProvider<AuthController, AsyncValue<void>>(
    (ref) => AuthController(authRepository: ref.watch(authRepositoryProvider), groups: ref.watch(groupControllerProvider)));
