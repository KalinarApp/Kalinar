...
_$_Skilltree _$$_SkilltreeFromJson(Map<String, dynamic> json) => _$_Skilltree(
      ...
      nodes: (json['nodes'] as List<dynamic>?)?.map((e) => Node.fromJson(e as Map<String, dynamic>)).toList() ?? const [],
    );

Map<String, dynamic> _$$_SkilltreeToJson(_$_Skilltree instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
